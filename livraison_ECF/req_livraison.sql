...
select CLIENT.NOCLIENT, CLIENT.NOTELEPHONE, COMMANDE.NOCOMMANDE from CLIENT, COMMANDE where COMMANDE.NOCLIENT = CLIENT.NOCLIENT 
  and TO_DATE(COMMANDE.DATECOMMANDE, 'DD/MM/YYYY') = TO_DATE('02/06/2000', 'DD/MM/YYYY');
...
select detaillivraison.NOLIVRAISON from livraison, detaillivraison where livraison.NOLIVRAISON = detaillivraison.NOLIVRAISON
  and TO_DATE(livraison.DATELIVRAISON, 'DD/MM/YYYY') = TO_DATE('04/06/2000', 'DD/MM/YYYY')
  group by detaillivraison.NOLIVRAISON having count(detaillivraison.NOLIVRAISON) > 1;
